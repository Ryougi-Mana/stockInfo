...
ENGINE = create_engine("mysql+pymysql://root:123@127.0.0.1:3306/sh_finance?charset=utf8mb4", )
...
if __name__ == '__main__':
    create_db()
    # showColumns();
    # main = MainIndicators(Code=1000, Code_Str='10000', Report_Period='2019-08-30', Indicator_Data='300wan',
    #                       Indicator_Name='利润')
    # insert(main)
